...
#demand_scales = [0.5, 0.6, 0.7, 0.8, 0.9, 1.0, 1.1, 1.2, 1.3, 1.4, 1.5]
#demand_scales = [0.1, 0.2, 1.8, 2.0]
#demand_scales = [0.01, 0.3, 0.4, 1.9]
demand_scales = [1.6, 1.7]
...
if __name__ == '__main__':
    for demand_scale in demand_scales:
        ...
        print(f"Solving sioux falls so. (demand scale: {demand_scale})")
        ...
        t0 = time.time()
        result.save(f'examples/results/sioux-falls-so-scale-{demand_scale}')
